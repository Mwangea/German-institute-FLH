        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 pt-16 sm:pt-20">
          ...
          <div className="mt-8 flex flex-row items-center justify-center gap-4 sm:gap-6 transition-all duration-700 animate-fade-in delay-700">
            <a className="w-[90%] sm:w-auto">
              ...
              className="w-full bg-button-50 hover:bg-orange-600 text-white px-6 py-3 sm:px-10 lg:px-12 sm:py-3.5 rounded-lg font-semibold font-serif transition-all duration-300 text-sm sm:text-lg transform hover:scale-105 shadow-md whitespace-nowrap">
                Apply Now
              </button>
            </a>
