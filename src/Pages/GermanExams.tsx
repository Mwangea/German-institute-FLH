  ...
  return (
    <>
      <SEO 
        ...
        description="Prepare for internationally recognized German language exams including Goethe-Zertifikat (A1-C2), TestDaF, and Goethe-Test PRO. Expert preparation and certification."
      />
