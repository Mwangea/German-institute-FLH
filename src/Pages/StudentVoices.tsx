...
const testimonials: StudentTestimonial[] = [
    {
      ...
      
      {
        id: 3,
        name: "XYZ",
        program: "Languages and Culinary Arts through the Institution of Foreign Language and Hospitality Management",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Hear directly from our students about their transformative journeys, 
              experiences, and how our institution helped shape their careers in the 
              hospitality industry.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <button className="inline-flex items-center gap-2 px-8 py-4 bg-primary-500 text-white rounded-full hover:bg-primary-600 transition-colors duration-300">
                <Play className="w-5 h-5" />
                Watch Stories
              </button>
              <button className="inline-flex items-center gap-2 px-8 py-4 bg-white text-gray-900 rounded-full hover:bg-gray-100 transition-colors duration-300">
                Share Your Story
              </button>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-gray-700">
              Our students come from diverse backgrounds and pursue various paths in 
              hospitality. Each story is unique, yet they all share a common thread 
                  ...
                  <div className="bg-gray-50 p-8 rounded-xl relative">
                    ...
                    <div className="ml-8">
                      ...
                      <div>
                        ...
                        <p className="text-primary-600">{testimonial.program}</p>
                      </div>
                    </div>
                  </div>
                </div>
