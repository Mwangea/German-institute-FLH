  ...
  return (
    <>
      <SEO 
        ...
        description="Explore exciting career opportunities in Germany through our apprenticeship programs, undergraduate degrees, and master's programs at the International Institute."
      />
