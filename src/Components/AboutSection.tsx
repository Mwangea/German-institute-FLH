            ...
            <div className="max-w-xl">
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gray-50 rounded-xl p-6 transform hover:-translate-y-1 transition-transform duration-300">
                  ...
                  To be a renowned institution recognized for
excellence in Language Training and Hospitality
Management, shaping globally competent
professionals who contribute to international
understanding and industry growth.
                ...
                <div className="bg-gray-50 rounded-xl p-6 transform hover:-translate-y-1 transition-transform duration-300">
                  ...
                  <p className="text-gray-700">
                  To equip individuals with practical language
skills and and Hospitality Expertise that empower
them to thrive in global environments, foster
cultural understanding, and enhance career
opportunities in the international job market
                  </p>
                </div>
              </div>
            </div>
