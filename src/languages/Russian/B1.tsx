...
const RussianB1 = () => {
  const levelData = {
    ...
    tagline: 'Develop your Russian skills to handle most situations and express yourself on familiar topics.',
    description: 'Develop your Russian skills to handle most situations and express yourself on familiar topics.',
    duration: '3 months',
    price: 'Kes 30,000',
    overview: 'Our B1 Russian course is designed for students who have completed A2 or have a solid foundation in Russian. You will develop your ability to handle most situations that may arise while traveling in Russian-speaking countries, express yourself on familiar topics, and understand the main points of clear standard input on familiar matters regularly encountered in work, school, and leisure.',
    ...
    targetAudience: 'Intermediate learners who have completed A2 level or have a solid foundation in Russian',
    ...
    ctaText: 'Start Your Journey to Intermediate Russian Proficiency',
    learningAreas: [
      {
      ...
      },
      {
        ...
        description: 'Deepen your understanding of Russian-speaking cultures',
        icon: Users
      },
      {
