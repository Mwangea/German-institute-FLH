...
const RussianLanguage = () => (
  <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-gray-300 mb-8">
              Start your journey to mastering Russian. Build fluency and receive certified CEFR-level credentials.
            </p>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-gray-700">
            Structured Russian courses aligned with CEFR standards (Common European Framework of Reference for Languages).
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {russianLevels.map((level, index) => (
            <div
              key={index}
    ...
    <section className="py-20 bg-primary-500 text-white text-center">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold mb-4">Ready to Learn Russian?</h2>
        <p className="text-lg mb-6">Join now and develop Russian skills for life, work, and travel.</p>
        <button
          //to="/enroll"
