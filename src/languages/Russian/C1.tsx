...
const RussianC1 = () => {
  const levelData = {
    ...
    tagline: 'Achieve near-native proficiency in Russian and master complex language structures.',
    description: 'Achieve near-native proficiency in Russian and master complex language structures.',
    duration: '3 months',
    price: 'Kes 30,000',
    overview: 'Our C1 Russian course is designed for students who have completed B2 or have an advanced level in Russian. You will develop your ability to understand a wide range of demanding, longer texts, and recognize implicit meaning. You will express yourself fluently and spontaneously without much obvious searching for expressions, use language flexibly and effectively for social, academic, and professional purposes, and produce clear, well-structured, detailed text on complex subjects.',
    ...
    targetAudience: 'Advanced learners who have completed B2 level or have strong upper-intermediate proficiency in Russian',
    ...
    ctaText: 'Start Your Journey to Advanced Russian Proficiency',
    learningAreas: [
      {
