...
const languageLevels: LanguageLevel[] = [
  {
    ...
    description: 'Understand and use familiar French expressions and very basic phrases aimed at satisfying simple needs.',
    duration: '2 months',
    price: 'Kes 20,000',
    url: '/french-levels/a1',
  },
  {
    level: 'A2',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-gray-300 mb-8">
                Master French from beginner to fluent speaker. Internationally recognized certification after each 2-3 month level.
              </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-gray-700">
              Structured French courses aligned with CEFR standards (Common European Framework of Reference for Languages).
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900">Why Choose Our French Courses</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              },
              {
                ...
                desc: 'Cost-effective and installment options to ensure quality French education for all.'
              },
              {
                icon: CheckCircle,
                title: 'Qualified Instructors',
                desc: 'Learn from certified French language experts and native speakers.'
              },
      ...
      <section className="py-20 bg-primary-500 text-white text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold mb-4">Ready to Learn French?</h2>
          <p className="text-lg mb-6">Join our next intake and become fluent with our expert-led French courses.</p>
          <Link
            to="/enroll"
