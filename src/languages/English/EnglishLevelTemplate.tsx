...
interface EnglishLevelTemplateProps {
  levelData: LevelData;
}

const EnglishLevelTemplate = ({ levelData }: EnglishLevelTemplateProps) => {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative py-20 md:py-28 bg-gradient-to-b from-gray-900 to-gray-800 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            src="/english.jpg"
            alt="English language class with students"
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-xl shadow-md p-8">
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {levelData.teachingMethods.map((method, index) => (
            ...
            <div className="space-y-8">
              ...
              {/* CTA Box */}
              <div className="bg-white rounded-xl shadow-md p-8">
                <h3 className="text-2xl font-bold mb-4">Begin Your English Journey</h3>
                <p className="mb-6">{levelData.ctaText}</p>
                <EnglishLevelForm level={levelData.level} />
              </div>
            </div>
          </div>
        </div>
...
export default EnglishLevelTemplate;
