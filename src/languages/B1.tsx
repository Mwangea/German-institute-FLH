...
const GermanLevelB1 = () => {
    const levelData = {
      ...
      outcomes: [
        ...
        'Understand texts with everyday language'
      ],
      certification: 'Goethe-Zertifikat B1',
      targetAudience: 'Learners with elementary German knowledge (completed A2)'
    };
