...
const GermanLevelC2 = () => {
    const levelData = {
      ...
      outcomes: [
        ...
        'Handle complex academic and professional materials'
      ],
      certification: 'Goethe-Zertifikat C2',
      targetAudience: 'Near-native level learners (completed C1)'
    };
