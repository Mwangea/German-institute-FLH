  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-gray-300 mb-8">
                Master Dutch from beginner to fluent speaker. Internationally recognized certification after each level.
              </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-gray-700">
              Structured Dutch courses aligned with CEFR standards (Common European Framework of Reference for Languages).
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900">Why Choose Our Dutch Courses</h2>
            ...
            {[
              {
                ...
                desc: 'Master reading, writing, speaking, and listening with practical exercises and real-world applications.'
              },
              {
                icon: Clock,
                title: 'Flexible Scheduling',
                desc: 'Choose from various study plans to match your learning pace and schedule.'
              },
              {
                icon: DollarSign,
                title: 'Affordable Pricing',
                desc: 'Cost-effective courses with quality materials and expert instruction.'
              },
              {
                icon: CheckCircle,
                title: 'Qualified Instructors',
                desc: 'Learn from certified Dutch language experts and native speakers.'
              },
      ...
      <section className="py-20 bg-primary-500 text-white text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold mb-4">Ready to Learn Dutch?</h2>
          <p className="text-lg mb-6">Join our next intake and become fluent with our expert-led Dutch courses.</p>
          <Link
            to="/enroll"
