...
import JapaneseLevelForm from "../../Forms/JapaneseLevelForm";
//import JapaneseLevelForm from "../../Forms/JapaneseLevelForm";
...
interface JapaneseLevelTemplateProps {
  levelData: LevelData;
}

const JapaneseLevelTemplate = ({ levelData }: JapaneseLevelTemplateProps) => {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative py-20 md:py-28 bg-gradient-to-b from-gray-900 to-gray-800 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            src="/Japanese.jpg"
            alt="Japanese language class with students"
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-8">
              ...
              {/* CTA Box */}
              <div className="bg-white rounded-xl shadow-md p-8">
                <h3 className="text-2xl font-bold mb-4">Begin Your Japanese Journey</h3>
                <p className="mb-6">{levelData.ctaText}</p>
                <JapaneseLevelForm level={levelData.level} />
              </div>
            </div>
          </div>
        </div>
...
export default JapaneseLevelTemplate;
