...
const SomaliC2 = () => {
  const levelData = {
    level: 'C2',
    title: 'Mastery Somali',
    tagline: 'Achieve native-like proficiency in Somali and master the language at its highest level.',
    duration: '3-6 months',
    price: 'Kes 20,000',
    overview: 'Our C2 Somali course is designed for students who have completed C1 or have near-native proficiency in Somali. You will develop your ability to understand with ease virtually everything heard or read, summarize information from different spoken and written sources, reconstructing arguments and accounts in a coherent presentation, and express yourself spontaneously, very fluently and precisely, differentiating finer shades of meaning even in the most complex situations.',
    format: 'Online and in-person classes available',
    objectives: [
      'Achieve native-like mastery of Somali',
    ...
    targetAudience: 'Advanced learners who have completed C1 level or have near-native proficiency in Somali',
    ...
    ctaText: 'Start Your Journey to Somali Language Mastery',
    learningAreas: [
      {
        title: 'Language Mastery',
        description: 'Achieve native-like command of Somali language',
        icon: GraduationCap
      },
      {
      ...
      },
      {
        ...
        description: 'Develop deep understanding of Somali culture and society',
        icon: Users
      },
      {
    ...
    resources: [
      ...
      'Authentic Somali media and literature',
