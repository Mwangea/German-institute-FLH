  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative py-20 md:py-28 bg-gradient-to-b from-gray-900 to-gray-800 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <div
            ...
            style={{
              backgroundImage: "url(/Arabic.jpg)",
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-gray-300 mb-8">
                Master Arabic from beginner to fluent speaker. Internationally recognized certification after each 3-month level.
              </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-gray-700">
              Structured Arabic courses aligned with CEFR standards (Common European Framework of Reference for Languages).
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900">Why Choose Our Arabic Courses</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              },
              {
                ...
                desc: 'Cost-effective and installment options to ensure quality Arabic education for all.'
              },
              {
                icon: CheckCircle,
                title: 'Qualified Instructors',
                desc: 'Learn from certified Arabic language experts and native speakers.'
              },
      ...
      <section className="py-20 bg-primary-500 text-white text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold mb-4">Ready to Learn Arabic?</h2>
          <p className="text-lg mb-6">Join our next intake and become fluent with our expert-led Arabic courses.</p>
          <Link
            to="/enroll"
