...
const PortugueseB2 = () => {
  const levelData = {
    ...
    targetAudience: 'Upper-intermediate learners who have completed B1 level or have strong intermediate proficiency in Portuguese',
    ...
    ctaText: 'Start Your Journey to Upper-Intermediate Portuguese Proficiency',
    learningAreas: [
      {
