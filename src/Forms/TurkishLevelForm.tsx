...
interface TurkishLevelFormProps {
  level: string;
}
...
const TurkishLevelForm = ({ level }: TurkishLevelFormProps) => {
    ...
    return (
      <div className="bg-green-50 rounded-lg p-6 text-center">
        ...
        <p className="text-green-700">
          We've received your application for Turkish {level}. Our team will 
...
export default TurkishLevelForm; 