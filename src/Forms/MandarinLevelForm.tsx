...
interface MandarinLevelFormProps {
  level: string;
}
...
const MandarinLevelForm = ({ level }: MandarinLevelFormProps) => {
    ...
    return (
      <div className="bg-green-50 rounded-lg p-6 text-center">
        ...
        <p className="text-green-700">
          We've received your application for Mandarin {level}. Our team will 
...
export default MandarinLevelForm; 