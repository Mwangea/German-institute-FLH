...
interface SomaliLevelFormProps {
  level: string;
}
...
const SomaliLevelForm = ({ level }: SomaliLevelFormProps) => {
    ...
    return (
      <div className="bg-green-50 rounded-lg p-6 text-center">
        ...
        <p className="text-green-700">
          We've received your application for Somali {level}. Our team will 
...
export default SomaliLevelForm; 