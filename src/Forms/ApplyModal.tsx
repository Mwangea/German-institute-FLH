            ...
            {step === 1 && (
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <label className="flex flex-col items-center justify-center w-full p-6 border-2 border-dashed rounded cursor-pointer hover:bg-gray-50">
                    <div className="flex flex-col items-center">
                      <Upload className="w-8 h-8 text-gray-500 mb-2" />
                      <p className="text-sm text-gray-500">
                        {formData.idFile ? formData.idFile.name : 'Upload ID (Passport, National ID, etc.)'}
                      </p>
                    </div>
                    <input 
                      type="file" 
