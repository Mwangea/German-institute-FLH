...
interface ArabicLevelFormProps {
  level: string;
}
...
const ArabicLevelForm = ({ level }: ArabicLevelFormProps) => {
    ...
    return (
      <div className="bg-green-50 rounded-lg p-6 text-center">
        ...
        <p className="text-green-700">
          We've received your application for Arabic {level}. Our team will 
...
export default ArabicLevelForm;