...
interface RussianLevelFormProps {
  level: string;
}
...
const RussianLevelForm = ({ level }: RussianLevelFormProps) => {
    ...
    return (
      <div className="bg-green-50 rounded-lg p-6 text-center">
        ...
        <p className="text-green-700">
          We've received your application for Russian {level}. Our team will 
...
export default RussianLevelForm; 