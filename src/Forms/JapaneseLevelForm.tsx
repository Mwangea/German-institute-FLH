...
interface JapaneseLevelFormProps {
  level: string;
}
...
const JapaneseLevelForm = ({ level }: JapaneseLevelFormProps) => {
    ...
    return (
      <div className="bg-green-50 rounded-lg p-6 text-center">
        ...
        <p className="text-green-700">
          We've received your application for Japanese {level}. Our team will 
...
export default JapaneseLevelForm; 