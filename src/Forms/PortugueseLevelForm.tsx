...
interface PortugueseLevelFormProps {
  level: string;
}
...
const PortugueseLevelForm = ({ level }: PortugueseLevelFormProps) => {
    ...
    return (
      <div className="bg-green-50 rounded-lg p-6 text-center">
        ...
        <p className="text-green-700">
          We've received your application for Portuguese {level}. Our team will 
...
export default PortugueseLevelForm; 