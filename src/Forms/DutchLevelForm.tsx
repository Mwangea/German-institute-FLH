...
const DutchLevelForm = ({ level }: DutchLevelFormProps) => {
    ...
    return (
      <div className="bg-green-50 rounded-lg p-6 text-center">
        ...
        <p className="text-green-700">
          We've received your application for Dutch {level}. Our team will 
