...
interface FrenchLevelFormProps {
  level: string;
}
...
const FrenchLevelForm = ({ level }: FrenchLevelFormProps) => {
    ...
    return (
      <div className="bg-green-50 rounded-lg p-6 text-center">
        ...
        <p className="text-green-700">
          We've received your application for French {level}. Our team will 
...
export default FrenchLevelForm; 