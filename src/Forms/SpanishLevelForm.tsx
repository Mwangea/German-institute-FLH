...
interface SpanishLevelFormProps {
  level: string;
}
...
const SpanishLevelForm = ({ level }: SpanishLevelFormProps) => {
    ...
    return (
      <div className="bg-green-50 rounded-lg p-6 text-center">
        ...
        <p className="text-green-700">
          We've received your application for Spanish {level}. Our team will 
...
export default SpanishLevelForm; 