...
interface ItalianLevelFormProps {
  level: string;
}
...
const ItalianLevelForm = ({ level }: ItalianLevelFormProps) => {
    ...
    return (
      <div className="bg-green-50 rounded-lg p-6 text-center">
        ...
        <p className="text-green-700">
          We've received your application for Italian {level}. Our team will 
...
export default ItalianLevelForm; 