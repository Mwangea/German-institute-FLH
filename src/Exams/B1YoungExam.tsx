        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-white text-center mb-6">
              Goethe-Zertifikat B1 for Young People
            </h1>
            <p className="text-xl text-gray-300 text-center mb-8">
              A German exam for independent young learners
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-sm p-8 mb-8">
              ...
              <ul className="space-y-4">
                {[
                  "Understand the main points of information in conversations and texts on familiar matters relating to work, school and leisure time",
            ...
            <div className="bg-gradient-to-br from-primary-600 to-primary-700 rounded-xl shadow-lg p-8 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h2 className="text-2xl font-bold text-white mb-4">
                  Interested in Taking the B1 Exam?
                </h2>
