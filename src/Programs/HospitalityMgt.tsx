...
const HospitalityMgt: React.FC = () => {
  return (
    <>
      <SEO 
        title="Hospitality Management Programs"
        description="Explore our comprehensive hospitality management programs including diplomas, certificates, and short courses. Prepare for a successful career in the global hospitality industry."
      />
