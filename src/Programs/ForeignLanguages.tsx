...
<<<<<<< HEAD
    <>
      <SEO 
        ...
        description="Discover our comprehensive foreign language programs including German, English, Spanish, French, and more. Expert instruction and internationally recognized certifications."
      />
